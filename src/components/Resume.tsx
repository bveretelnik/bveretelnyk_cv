        ...
        <div className="bg-gray-800 p-6 rounded shadow-md">
          ...
          <section className="mb-6">
            ...
            <p>
              ...
              implementing scalable web applications using React, TypeScript,
              and Next.js. Strong in architecture planning, UI/UX collaboration,
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                Frontend: React, Redux, Next.js, React Native, Styled Components
              </li>
          ...
          <section className="mb-6">
            ...
            <div className="mt-2">
              ...
              <ul className="list-disc list-inside mt-1">
                <li>
                  Developed core UI features for a sportsbook platform
                  (Next.js).
                </li>
                <li>
                  Built reusable components like sidebar, navbar, tabs, bet
                  builder.
                </li>
                <li>
                  Improved scalability and introduced architecture enhancements.
                </li>
              </ul>
            </div>
            ...
            <div className="mt-4">
              <h3 className="text-lg font-bold">
                Frontend Developer – Bananza.agency
              </h3>
              <p className="text-sm italic">Sep 2020 – Jun 2022 | Ukraine</p>
              <ul className="list-disc list-inside mt-1">
                <li>
                  Developed investment section of a banking platform with 300+
                  devs.
                </li>
                <li>
                  Replaced legacy logic, improving feature delivery speed.
                </li>
